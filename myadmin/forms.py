...
class VideoPublishForm(forms.ModelForm):
    ...
    class Meta:
        model = Video
        fields = ['title', 'desc', 'status', 'vip', 'cover', 'classification']
...
class VideoEditForm(forms.ModelForm):
    ...
    class Meta:
        model = Video
        fields = ['title', 'desc', 'status', 'vip', 'cover',
                  'classification', 'view_count', 'index_show', ]
...
class UserAddForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'password', 'is_staff', 'vip', 'expire']
...
class UserEditForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ['username', 'is_staff', 'vip', 'expire', 'avatar',
                  'nickname', 'email', 'mobile', 'gender', 'subscribe']
...
class FileAddForm(forms.ModelForm):
    ...
    class Meta:
        model = FileClass
        fields = ['file', 'desc', 'code', 'status', 'vip']
...
class FileEditForm(forms.ModelForm):
    ...
    class Meta:
        model = FileClass
        fields = ['file', 'desc', 'code', 'view_count', 'status', 'vip']
